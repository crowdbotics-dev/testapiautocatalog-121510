...
## Project Structure
    ...
    ├── testapiautocatalog_121510  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_121510`
...
2. Clone this repo and `cd testapiautocatalog_121510`
